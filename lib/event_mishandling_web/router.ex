defmodule EventMishandlingWeb.Router do
  ...
  # scope "/api", EventMishandlingWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:event_mishandling, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EventMishandlingWeb.Telemetry
